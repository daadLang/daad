...
[القواعد](docs/grammar.md) · [الأمثلة](tests/examples/)
...
- المُفسِّر يُنفِّذ الكود مباشرةً من شجرة الصياغة المجردة (AST) بدون تحويل إلى كود ثائي (Bytecode)
...
```
                                         /daad
                      أوامر سطر الأوامر #                 /cmd ──┬
                                  /internals ──┤
           شجرة الصياغة المجردة #           /ast ──┬     │
             المفسر ووقت التشغيل #   /interpreter ──┤     │
                    محلل الرموز #         /lexer ──┤     │
                  المحلل النحوي #        /parser ──┴     │
                                     /tests ──┤
                    أمثلة برامج ض #      /examples ──┬     │
                   اختبارات الوحدات #            ... ──┴     │
                         التوثيق #                /docs ──┤
